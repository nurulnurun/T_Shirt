    ...
    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
            ...
            <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../dashboard/auth/confirm-mail.html">
                        ...
                        <i class="sidenav-mini-icon"> C </i>
                        <span class="item-name">View All Customers</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../dashboard/auth/lock-screen.html">
                        ...
                        <i class="sidenav-mini-icon"> L </i>
                        <span class="item-name">Customer Login</span>
                    </a>
                </li>
                <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link " href=" {{ route('Backend.Product-List') }} ">
                        <i class="icon">
                            <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                <g>
                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <span class="item-name">All Products Details</span>
                    </a>
                </li>
                <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-widget" data-bs-parent="#sidebar-menu">
                <li class="nav-item">
                    <a class="nav-link " href="../dashboard/widget/widgetbasic.html">
                        ...
                        <span class="item-name">Add New Brands</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href=" {{ route('Backend.Brand-List')}} ">
                        <i class="icon">
                            <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                <g>
                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                        ...
                        <i class="sidenav-mini-icon"> W </i>
                        <span class="item-name">All Brands Details</span>
                    </a>
                </li>
                 <li class="nav-item">
            ...
            <ul class="sub-nav collapse" id="sidebar-form" data-bs-parent="#sidebar-menu">
                <li class="nav-item">
                    <a class="nav-link " href="../dashboard/form/form-element.html">
                       ...
                       <span class="item-name">Add New Orders</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="../dashboard/form/form-wizard.html">
                        ...
                        <i class="sidenav-mini-icon"> W </i>
                        <span class="item-name">All Order Details</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="../dashboard/icons/solid.html">
                        ...
                        <i class="sidenav-mini-icon"> S </i>
                         <span class="item-name">Add New Delivery Address</span>
                    </a>
                </li>
                <li class="nav-item">
